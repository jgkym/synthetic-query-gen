...
def initialize_llama_model(
    model_path: str, n_gpu_layers: int = -1, n_ctx: int = 0, verbose: bool = False
) -> Llama:
    """
...
def configure_llama_cpp_model(
    repo_id: str, model_name: str, local_dir: str, temperature: float = 0.0
) -> LlamaCpp:
    """
    ...
    return LlamaCpp(
        model="llama", llama_model=llm, model_type="chat", temperature=temperature
    )
